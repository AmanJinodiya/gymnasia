...
import com.example.gymnasia.databinding.ActivityOtpactivityBinding
        ...
        auth.signInWithCredential(credential)
            .addOnCompleteListener(this) { task ->
                if (task.isSuccessful) {
                    ...
                    Toast.makeText(this, "Authenticate Successfully activity", Toast.LENGTH_SHORT).show()
                    startActivity(Intent(this,dash::class.java).putExtra("Email",phoneNumber))
//                    sendToMain()
                } else {
